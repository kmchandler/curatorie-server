...
from curatorieapi.views import register_user, check_user, BoardView, GiftCardView, InspoCardView, ListCardView, PurchaseCardView, SharedBoardView, UserView, BoardTypeView, IconView, ShareRequestView
